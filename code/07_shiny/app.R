        ...
        navset_card_underline(
             nav_panel("Introduction",
               ...
               tags$span("Occupancy models are frequently used to estimate species distributions while 
                         ...
                         accuracy and precision of spatial occupancy model estimates. Our simulations focus on a 
                         spatial occupancy model implemented in the spOccupancy R package using Nearest Neighbor 
                         Gaussian Processes (NNGP). We explicitly quantify the effects of sample size, sampling 
                         design, species prevalence, the number of neighbors used in the NNGP, and the effective 
                         spatial range of spatial autocorrelation on the accuracy and precision of occupancy predictions.", style = "font-size: 14px"), 
