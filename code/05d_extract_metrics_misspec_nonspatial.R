# 05d_extract_metrics_nonspatial.R: script to process the massive amount of results files
...
for (i in 1:n_total) {
  ...
  tryCatch({
    load(Sys.glob(paste0(results_dir, 'misspec-nonspatial-occupancy-sampling-row-', curr_row, 
...
save(summary_df, file = paste0(results_dir, "misspec-nonspatial_summary_sim_2_results.rda"))
