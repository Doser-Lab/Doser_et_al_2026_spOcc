...
do 
  ...
  bsub -n 1 -W 7200 -R span[hosts=1] -R "rusage[mem=5]" -q cnr -oo out.04b_main_test.$start_row -eo err.04b_main_test.$start_row "Rscript 04b_main_nonspatial_misspec.R $start_row $reps"
