...
#script for making things to store in .rda so app loads easier
rm(list = ls())
library(dplyr)
library(spOccupancy)
library(ggplot2)
...
#PANEL 2: SAMPLING DESIGNS (sampling_design.rda)------------------------------------------------------------------------
    ...
    save(base.plot, random.plot, sys.plot, hline.plot, vline.plot, box4.plot, box16.plot, mod.pref.plot, heavy.pref.plot, 
         display.all.plot, file = "sampling_design.rda")

#PANEL 3: 1 PARAMETER VISIALIZATIONS (one_parameter.rda) ------------------------------
    load("summary_sim_1_results.rda")
    ...
    load("nonspatial_summary_sim_1_results.rda")
    ...
    save(prev_fig_df, decay_fig_df, n_plot_fig_df, design_fig_df, neighbors_fig_df, file = "one_parameter.rda")
...
#PANEL 4 & 5: 2 & 3 PARAMETER VISIALIZATIONS (multi_parameter.rda), --------------------------------------------------------------------
    ...
    save(avg_by_scenario, file = "multi_parameter.rda")
